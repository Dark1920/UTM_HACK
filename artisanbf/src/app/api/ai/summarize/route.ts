...
function parseSummary(input: unknown): Summary {
  if (!input || typeof input !== "object") {
    throw new Error("AI: sortie non-object pour Summary")
  }
  ...
  if (typeof resume !== "string") {
    throw new Error("AI: Summary.resume invalide")
  }

  if (!isStringArray(points_forts)) {
    throw new Error("AI: Summary.points_forts invalide")
  }

  if (!isStringArray(points_faibles)) {
    throw new Error("AI: Summary.points_faibles invalide")
  }
