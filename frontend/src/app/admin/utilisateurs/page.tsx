...
import { Search, Trash2, UserCheck, UserX, Loader2 } from 'lucide-react';
...
export default function UtilisateursPage() {
  ...
  const loadUsers = () => {
    setLoading(true);
    adminService.getUsers({ role: roleFilter === 'all' ? undefined : roleFilter, search: search || undefined })
      .then((res) => setUsers(res.utilisateurs))
      .catch(console.error)
