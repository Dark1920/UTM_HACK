  ...
  return (
    <div ref={containerRef} className="relative inline-block">
      ...
      <div
        data-dropdown-menu
        className={[
          "hidden absolute z-50 mt-1 min-w-[180px] rounded-xl border border-stone-200 bg-white py-1.5 shadow-xl",
      ...
      >
        {items.map((item, index) =>
          item.divider ? (
            <div key={index} className="my-1 border-t border-stone-100" role="separator" />
          ) : (
            <button
              key={index}
