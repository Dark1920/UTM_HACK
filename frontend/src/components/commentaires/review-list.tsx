      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <select
            ...
            className="appearance-none rounded-md border border-slate-200 bg-white px-2 py-1 text-xs text-slate-600 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              {review.iaResume && (
                <div className="mt-3 flex items-start gap-2 rounded-lg bg-blue-50 px-3 py-2">
                  <Brain className="h-4 w-4 shrink-0 text-blue-500 mt-0.5" />
                  <div>
                    <Badge variant="info" size="sm" className="mb-1">
                      Résumé IA
                    </Badge>
                    <p className="text-xs text-blue-700">{review.iaResume}</p>
                  </div>
                </div>
              )}
            </div>
