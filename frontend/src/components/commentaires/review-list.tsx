  ...
  if (reviews.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        <div className="mb-4 flex h-20 w-20 items-center justify-center rounded-lg bg-stone-100">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <select
            ...
            className="appearance-none rounded-lg border border-stone-200 bg-white px-3 py-1.5 text-xs text-stone-600 focus:border-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-400/30 transition-all duration-200"
          >
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              {review.iaResume && (
                <div className="mt-3 flex items-start gap-2.5 rounded-lg bg-info-50 px-4 py-3">
